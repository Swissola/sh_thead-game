...
- [x] **RESP-01**: The board and every component reflow to fit a phone-sized screen without overflow (Tailwind breakpoints replace fixed-pixel layouts)
- [x] **RESP-02**: Card details/tooltips are accessible via touch, not just mouse hover
- [x] **RESP-03**: Every interactive control (sort buttons, cards, etc.) meets a minimum 44px touch target
